...
- **`v1.1`** or **`latest`**: The updated PET-MAD model with a new, pure PyTorch backend, slightly improved performance and ability to run simulations using the non-conservative forces and stresses.
