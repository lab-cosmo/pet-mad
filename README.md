...
📖 **Full documentation:** <https://upet.readthedocs.io>
...
See the [installation guide](https://upet.readthedocs.io/en/latest/installation.html)
...
[models documentation](https://upet.readthedocs.io/en/latest/models.html).
...
- [ASE workflows](https://upet.readthedocs.io/en/latest/usage/ase.html):
...
- [Batched evaluation with metatrain](https://upet.readthedocs.io/en/latest/usage/metatrain.html).
- [LAMMPS](https://upet.readthedocs.io/en/latest/usage/lammps.html) (including
  KOKKOS GPU support),
  [i-PI](https://upet.readthedocs.io/en/latest/usage/ipi.html),
  [TorchSim](https://upet.readthedocs.io/en/latest/usage/torchsim.html), and
  [GROMACS](https://upet.readthedocs.io/en/latest/usage/gromacs.html) interfaces.
- [Fine-tuning](https://upet.readthedocs.io/en/latest/fine-tuning.html) and
  [example gallery](https://upet.readthedocs.io/en/latest/generated_examples/index.html).
- [FAQ and known issues](https://upet.readthedocs.io/en/latest/faq.html).
- [How to cite](https://upet.readthedocs.io/en/latest/cite.html) UPET and its
  underlying models.
